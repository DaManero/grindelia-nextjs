    ...
    <>
      ...
      <div className="container">
        <LightGallery
          ...
          elementClassNames="cs_grid_style_2 cs_lightgallery"
        >
          {data?.map((item, index) => (
            <div className="cs_grid_item" key={index} href={item.imgUrl}>
              <div
                className="cs_gallery_item cs_lightbox_item cs_style_3 d-block cs_bg_filed position-relative"
                style={{ backgroundImage: `url(${item.imgUrl})` }}
              >
                <div className="cs_gallery_item_hover cs_primary_font cs_fs_38">
                  <span className="cs_hover_icon cs_accent_color">
                    ...
                    >
                      ...
                      <defs>
                        <clipPath className="clip0_441_197">
                          <rect width={30} height={30} fill="white" />
                        </clipPath>
                      </defs>
                    </svg>
                  </span>
                  <span className="cs_hover_text cs_primary_font cs_primary_color cs_fs_38">
                    {item.title}
                  </span>
                </div>
                <img src={item.imgUrl} alt="" className="d-none" />
              </div>
            </div>
          ))}
        </LightGallery>

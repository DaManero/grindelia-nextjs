...
import RoomDetailsFeatureList from '../Section/RoomDetailsFeatureList';
import ProductBannerStyle2 from '../Section/ProductBanner/ProductBannerStyle2';
...
const roomFeatureListData = [
  {
    title: 'Overview',
    features: [
      `<b>Room Size:</b> 41 – 45 sq m / 441 – 484 sq ft`,
      `<b>Bed Size:</b> King or Regular`,
      `<b>Occupancy:</b> Up to 3 adults`,
      `<b>Location:</b> 2/F – 6/F (Original Building)`,
      `<b>View:</b> Panama Sea view`,
      `<b>Bed:</b> 250 Thread Count Sheets`,
      `<b>Smoking:</b> Yes`,
      `<b>Room Service:</b> Yes`,
    ],
  },
  {
    title: 'Features',
    features: [
      `Contained a special personal terrace`,
      `Watching videos about mountaineering on a TV-UHD screen`,
      `Seat with upholstery next to the expansive window`,
      `Writing desk with USB connections so you may record travel experiences`,
      `Your top mountain images are safe in your room.`,
      `Cosy bathrobes and terry towels`,
      `Bathroom with rain shower`,
    ],
  },
];

export default function RoomDetailsPageV3() {
  pageTitle('Room Details V3');
  useEffect(() => {
  ...
  return (
    <>
      ...
      >
        <ProductBannerStyle2
          imgUrl="/images/page_heading_bg_rooms.jpeg"
          title="Deluxe Rooms"
          currency="$"
          price={320}
      ...
      <Section
        ...
        bottomSpaceMd="0"
      >
        <RoomDetailsFeatureList data={roomFeatureListData} />
      </Section>
      <Section
        topSpaceLg="140"
        topSpaceMd="75"

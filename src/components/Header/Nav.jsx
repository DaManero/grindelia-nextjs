  ...
  return (
    <nav className={variant ? variant : "cs_nav cs_fs_13 cs_semibold"}>
      ...
      <ul className={`cs_nav_list ${mobileToggle ? "cs_active" : ""}`}>
        <li>
          <Link href="/" className="cs_white_color" onClick={handleHomeClick}>
            Inicio
          </Link>
        </li>
        <li>
          <Link href="/about" className="cs_white_color">
            Sobre Nosotros
          </Link>
        </li>
        <li className="menu-item-has-children">
          <Link href="/rooms" className="cs_white_color">
            Habitaciones
          </Link>
          <DropDown>
            <ul>
        ...
        <li>
          <Link href="/services" className="cs_white_color">
            Servicios
          </Link>
        </li>
        <li>
          <Link href="/gallery" className="cs_white_color">
            Galería
          </Link>
        </li>
        <li>
          <Link href="/contact" className="cs_white_color">
            Contacto
          </Link>
        </li>
      </ul>
